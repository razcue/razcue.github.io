...
description: 'Explora cómo Astro está revolucionando el desarrollo web con hidratación parcial, cero JS por defecto, y métricas con rendimiento increíble que realmente importan.'
pubDate: 2024-01-15
...
<div className="grid grid-cols-2 lg:grid-cols-4 gap-4 my-8 p-6 bg-surface rounded-lg">
  ...
  <CircularScore score={94} label="Accessibility" client:visible />
  <CircularScore score={100} label="Best Practices" client:visible />
  <CircularScore score={92} label="SEO" client:visible />
</div>
